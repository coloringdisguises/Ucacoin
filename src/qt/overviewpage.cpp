...
#define NEWS_URL "https://ucacoin.org/category/news/feed"
...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate() : QAbstractItemDelegate(), unit(BitcoinUnits::UCA)
    {
    }
                              ...
                              const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    // UCA Available
    bool showUCAAvailable = settingShowAllBalances || reexAvailableBalance != nTotalBalance;
    bool showWatchOnlyUCAAvailable = showUCAAvailable || nAvailableWatchBalance != nTotalWatchBalance;
    ui->labelBalanceText->setVisible(showUCAAvailable || showWatchOnlyUCAAvailable);
    ui->labelBalance->setVisible(showUCAAvailable || showWatchOnlyUCAAvailable);
    ui->labelWatchAvailable->setVisible(showUCAAvailable && showWatchOnly);

    // UCA Pending
    bool showUCAPending = settingShowAllBalances || unconfirmedBalance != 0;
    bool showWatchOnlyUCAPending = showUCAPending || watchUnconfBalance != 0;
    ui->labelPendingText->setVisible(showUCAPending || showWatchOnlyUCAPending);
    ui->labelUnconfirmed->setVisible(showUCAPending || showWatchOnlyUCAPending);
    ui->labelWatchPending->setVisible(showUCAPending && showWatchOnly);
    ...
    // UCA Locked
    bool showUCALocked = settingShowAllBalances || nLockedBalance != 0;
    bool showWatchOnlyUCALocked = showUCALocked || nWatchOnlyLockedBalance != 0;
    ui->labelLockedBalanceText->setVisible(showUCALocked || showWatchOnlyUCALocked);
    ui->labelLockedBalance->setVisible(showUCALocked || showWatchOnlyUCALocked);
    ui->labelWatchLocked->setVisible(showUCALocked && showWatchOnly);
...
void OverviewPage::SetLinks()
{
    ...
    ui->labelLinksUrl1->setText("<a href=\"https://ucacoin.com/\">https://ucacoin.com</a>");
    ui->labelLinksUrl2->setText("<a href=\"http://blockexplorer.ucacoin.cash\">http://blockexplorer.ucacoin.cash</a>");
    ui->labelLinksUrl3->setText("<a href=\"https://discord.gg/pD6W6Xt\">https://discord.gg/pD6W6Xt</a>");
    ui->labelLinksUrl4->setText("<a href=\"https://twitter.com/ucacoin\">https://twitter.com/ucacoin</a>");
    ui->labelLinksUrl6->setText("<a href=\"https://github.com/ucacoin\">https://github.com/ucacoin</a>");
