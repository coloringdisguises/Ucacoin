...
#   c) node1 mines 32 blocks, so now node 0 has 500000UCA, node 1 has 4250UCA, node2 has none.
#   d) node0 sends 601 UCA to node2, in two transactions (301 UCA, then 300 UCA).
