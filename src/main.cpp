...
int64_t GetBlockValue(int nHeight)
{
    ...
    } else if (nHeight > 1 && nHeight <= 201)       { nSubsidy = 25000000 * COIN;//premimed
    } else if (nHeight > 201) { nSubsidy = 475 * COIN; 
    } else if (nHeight > 2100000) { nSubsidy = 237.50 * COIN; 
    } else if (nHeight > 4200000) { nSubsidy = 118.75 * COIN; 
    } else if (nHeight > 8400000) { nSubsidy = 59.37 * COIN; 
    } else if (nHeight > 16800000) { nSubsidy = 29.68 * COIN;
    } else if (nHeight > 33600000) { nSubsidy = 14.84 * COIN; 
    } else if (nHeight > 67200000) { nSubsidy = 7.42 * COIN; }
    return nSubsidy;
}
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue, int nMasternodeCount)
{
    ...
    if (nHeight <= 200)                               { ret = blockValue * 0.10;
      } else if (nHeight > 201)                    { ret = blockValue * 0.30; }
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // UCA: We use certain sporks during IBD, so check to see if they are
